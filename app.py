...
# ---------- CSS for Cute Background & Cards ----------
st.markdown("""
<style>
.stApp { 
    background: linear-gradient(180deg,#a0c4ff 0%, #6699ff 45%, #3b7df0 100%);
    color:#ffffff; 
    font-family:-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Arial; 
    overflow-x:hidden;
    background-image: radial-gradient(circle at 20% 20%, rgba(255,255,255,0.05) 2px, transparent 2px),
...
.card { 
    ...
    padding:18px; 
    margin-bottom:12px; 
    box-shadow:0 6px 30px rgba(2,10,40,0.3); 
...
.polaroid { 
    ...
    margin:10px; 
    border-radius:8px; 
    box-shadow:0 8px 30px rgba(2,8,30,0.3); 
...
# Timeline
    ...
    st.write("Add important moments here.")
    st.markdown("</div>", unsafe_allow_html=True)
